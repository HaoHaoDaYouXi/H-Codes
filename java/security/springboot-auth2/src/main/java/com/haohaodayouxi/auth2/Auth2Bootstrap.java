package com.haohaodayouxi.auth2;
...
@MapperScan(basePackages = {"com.haohaodayouxi.auth2.mapper"})
public class Auth2Bootstrap {
    public static void main(String[] args) {
        ApplicationContext applicationContext = SpringApplication.run(Auth2Bootstrap.class, args);
