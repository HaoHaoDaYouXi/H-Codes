package com.haohaodayouxi.shiro;
...
@MapperScan(basePackages = {"com.haohaodayouxi.shiro.mapper"})
public class ShiroBootstrap {
    public static void main(String[] args) {
        ApplicationContext applicationContext = SpringApplication.run(ShiroBootstrap.class, args);
