package com.haohaodayouxi.camunda;
...
@MapperScan(basePackages = {"com.haohaodayouxi.camunda.mapper"})
public class CamundaBootstrap {
    public static void main(String[] args) {
        ApplicationContext applicationContext = SpringApplication.run(CamundaBootstrap.class, args);
