package com.haohaodayouxi.freemarker;
...
@MapperScan(basePackages = {"com.haohaodayouxi.freemarker.mapper"})
public class FBootstrap {
    public static void main(String[] args) {
        ApplicationContext applicationContext = SpringApplication.run(FBootstrap.class, args);
