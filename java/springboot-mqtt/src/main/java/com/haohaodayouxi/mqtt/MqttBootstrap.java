package com.haohaodayouxi.mqtt;
...
@MapperScan(basePackages = {"com.haohaodayouxi.mqtt.mapper"})
public class MqttBootstrap {
    public static void main(String[] args) {
        ApplicationContext applicationContext = SpringApplication.run(MqttBootstrap.class, args);
