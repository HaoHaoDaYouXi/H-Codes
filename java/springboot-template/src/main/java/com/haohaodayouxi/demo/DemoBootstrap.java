package com.haohaodayouxi.demo;
...
@MapperScan(basePackages = {"com.haohaodayouxi.demo.mapper"})
public class DemoBootstrap {
    public static void main(String[] args) {
        ApplicationContext applicationContext = SpringApplication.run(DemoBootstrap.class, args);
